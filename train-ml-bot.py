...
#player1 = ml.Bot(model_file='./bots/ml/rand-model.pkl')
#player2 = ml.Bot(model_file='./bots/ml/rdeep-model.pkl')

from bots.ml.ml import features

def create_dataset(path, player= rdeep.Bot(), games=10000, phase=1):
...
if options.train:
    ...
    learner = MLPClassifier(hidden_layer_sizes=hidden_layer_sizes, learning_rate_init=learning_rate, alpha=regularization_strength, verbose=True, early_stopping=True, n_iter_no_change=10)
    ...
    joblib.dump(model, "./bots/ml/agent9-" + options.model_path)
